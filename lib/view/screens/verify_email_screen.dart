...
class _VerifyEmailPageState extends State<VerifyEmailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Consumer<VerifyEmailScreenController>(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text('Click on Verify Email to send verification email!',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: displayWidth(context) * 0.05,
                          color: Colors.blue,
                      ...
                      ElevatedButton.icon(
                        ...
                        label: controller.isMailSent ? Text(
                          'Resend Email',
                          style: TextStyle(
