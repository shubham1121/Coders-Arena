                            ...
                            Material(
                              ...
                              child: InkWell(
                                ...
                                child: CustomIconTextButton(
                                  ...
                                  iconData: Icons.abc,
                                  isText: true,
                                  text: controller.user!.myPosts.length >= 10
                                      ? controller.user!.myPosts.length
                                          .toString()
                                      : '0${controller.user!.followers.length}',
                                ),
                              ),
